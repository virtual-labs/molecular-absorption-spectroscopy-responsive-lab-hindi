...
function flask() {
    if ( step_no == 2 && count ==1){
        ...
        moveImage();
      // Change to next intsruction to be followed.
      document.getElementById("demo").innerHTML = "चरण- 4: साफ, सूखे बीकर में घोल डालने के लिए शंक्वाकार फ्लास्क पर क्लिक करें";
        step_no ++;
    }
...
function cuvette(event){
    if ( step_no == 6 && count == 6){
      ...
      document.getElementById("demo").innerHTML = "चरण संख्या 7: विंदुक पर क्लिक करके माइक्रोवेट से क्युवेट में घोल डालें (वास्तविक माप में क्युवेट इसकी मात्रा के दो-तिहाई से भर जाता है।";

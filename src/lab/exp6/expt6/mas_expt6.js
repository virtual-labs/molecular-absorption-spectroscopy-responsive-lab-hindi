...
function removeClock() {
  ...
  document.getElementById("demo").innerHTML = "चरण संख्या 2: पोटेशियम डाइक्रोमेट की उचित सांद्रता (जैसे, 0.001 M, 0.00075M, 0.001 M) के तीन जलीय घोल बनाएं [समाधान की उपयुक्त एकाग्रता चुनने के लिए एकाग्रता बार पर क्लिक करें और खींचें, जिसका अवशोषण मापा जाना है]। सबसे पहले सबसे कम एकाग्रता समाधान के साथ शुरू करना चाहिए। साफ, सूखे बीकर लेने के लिए बीकर पर क्लिक करें।";

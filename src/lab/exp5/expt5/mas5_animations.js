...
function beaker() {
  if(step_no==1){
    ...
    document.getElementById("demo").innerHTML = "चरण संख्या 3: प्रयोग तालिका के लिए इसे ले जाने के लिए 2-नाइट्रोनिलिन फ्लास्क पर क्लिक करें";
...
function flask() {
    if ( step_no == 2 && count == 1){
        ...
        moveImage();
      // Change to next intsruction to be followed.
      document.getElementById("demo").innerHTML = "चरण संख्या 4: साफ, सूखे बीकर में घोल डालने के लिए 2-नाइट्रोनाइलाइन फ्लास्क पर क्लिक करें";
        step_no ++;
    }

...
function beaker() {
    if(step_no==1){
      ...
      document.getElementById("demo").innerHTML = "चरण- 3: प्रयोग की मेज पर ले जाने के लिए फ्लास्क पर क्लिक करें";
...
function flask() {
  if (step_no == 2 && count == 1){
    ...
    moveImage();
    // Change to next intsruction to be followed.
    document.getElementById("demo").innerHTML = "चरण-संख्या 4: स्वच्छ, सूखे बीकर में घोल डालने के लिए कुप्पी पर क्लिक करें";
    step_no++;
  }
...
function moveFlask() {
  ...
  // Change to next intsruction to be followed.
  document.getElementById("demo").innerHTML = "चरण-संख्या ५: बीकर से उचित मात्रा में घोल एकत्र करने के लिए माइक्रोप्रिपेट पर क्लिक करें";
...
function pipette() {
  if (step_no == 4 && count == 4){
    ...
    fillPipette();
    // Change to next instruction to be followed.
    document.getElementById("demo").innerHTML = "चरण 6: उस पर क्लिक करके cuvette लें";
    step_no ++;
  }
...
function cuvette(){
  if ( step_no == 6 && count == 6){
    ...
    document.getElementById("demo").innerHTML = "चरण -7 7: क्युवेट पर क्लिक करके माइक्रोवेट से क्युवेट में घोल डालें (वास्तविक माप में क्युवेट इसकी मात्रा के दो-तिहाई भाग से भरा है।";
